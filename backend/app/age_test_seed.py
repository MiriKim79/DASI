...
- #7 19세 실사용자 exploratory test 피드백 반영(문구만, 숫자 불변): Q2 subtitle에
  "가장 자주 겪었던 상황을 골라줘"를 추가해 카톡/DM처럼 복수 경험이 겹칠 때의 선택
  기준을 명확히 했다. Q6은 "유튜브"가 3번째 선택지(방송사·포털)에 있어 유튜브 이용자가
  실제 세대보다 나이 많은 쪽으로 끌릴 수 있다는 피드백에 따라 "유튜브"를 4번째
  선택지(OTT)로 옮겼다. representative_age/weight는 값도 순서도 그대로다.
"""
...
QUESTIONS = [
    ...
    (
        ...
        "중학교 무렵, 여러 개 겪었어도 가장 자주 겪었던 상황을 골라줘.",
        "EXPERIENCE",
        1.5,
        [
            ...
            ("페이스북 메신저 접속 상태를 보면서 답장을 기다렸다", 32),
    ...
    (
        ...
        [
            ...
            ("방송사 홈페이지·포털에서 다시보기나 클립을 찾아봤다", 24),
            ("유튜브·OTT에서 바로 찾아봤다", 19),
        ],
    ),
    (
