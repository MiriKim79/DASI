...
const GREETING_LINES = {
  "1990s": [
    "안녕! 나는 모리야. Memory에서 따온 이름이지. 1990년대 추억을 잔뜩 품고 있는 모리인데, 개그 퀴즈 풀어볼래 아니면 그 시절 얘기 좀 나눠볼래?",
    "하이! 나 모리라고 해. 이름은 Memory에서 따왔어. 1990년대 추억을 간직하고 있거든 — 개그 퀴즈 풀어볼래, 아니면 옛날 얘기 좀 해볼래?",
    "안녕~ 나는 모리야, Memory에서 따온 이름이야. 1990년대 그 시절 추억을 품고 있어. 개그 퀴즈 풀래, 아니면 그때 얘기해볼래?",
  ],
  "2000s": [
    "안녕~ 나 모리야! 이름은 Memory에서 따왔어 ㅋㅋ 2000년대 추억을 간직한 모리거든. 개그 퀴즈 풀어볼래, 아니면 그 시절 얘기해볼래?",
    "방가방가! 나는 모리, Memory에서 따온 이름이야. 2000년대 추억을 품고 있는데, 개그 퀴즈 풀어볼래 아니면 그때 얘기 좀 해볼래?",
    "안녕! 나 모리야. 이름은 Memory에서 따왔어. 2000년대 추억 간직한 모리인데, 개그 퀴즈 풀어볼래 아니면 그때 얘기해볼래? ㅋㅋ",
  ],
  "2010s": [
    "안녕! 나는 모리, 이름은 Memory에서 따왔어. 2010년대 추억을 품고 있는 모리인데, 완전 개그 퀴즈 풀어볼래 아니면 그때 얘기해볼래?",
    "헐 안녕! 나 모리야, Memory에서 따온 이름이지. 2010년대 추억 간직한 모리인데, 개그 퀴즈 풀어볼래 아니면 그때 얘기해볼래?",
    "안녕! 나는 모리야. 이름은 Memory에서 따왔어. 2010년대 추억을 품고 있는데, 레알 개그 퀴즈 풀어볼래 아니면 그때 얘기해볼래?",
  ],
  "2020s": [
    "안녕! 나 모리야, 이름은 Memory에서 따왔어. 2020년대 추억 간직한 모리인데 ㄹㅇ, 개그 퀴즈 풀어볼래 아니면 그때 얘기해볼래?",
    "안뇽! 나는 모리, Memory에서 따온 이름이야. 2020년대 추억을 품고 있는 모리인데, 개그 퀴즈 풀어볼래 아니면 그때 얘기 좀 해볼래?",
    "안녕! 나 모리야. 이름은 Memory에서 따왔어. 2020년대 추억 간직한 모리인데, 갓생 살듯 개그 퀴즈 풀어볼래 아니면 그때 얘기해볼래?",
  ],
  default: [
    "안녕! 나는 모리야. 이름은 Memory에서 따온 거야. 그 시절 추억을 간직한 모리인데, 개그 퀴즈 풀어볼래 아니면 그때 얘기해볼래?",
  ],
};
