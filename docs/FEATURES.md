...
**캐릭터 이름: 모리(MORI)** — "Memory"에서 따온 이름, "추억을 기억하고 꺼내주는 강아지" 컨셉. 레트로 강아지 마스코트, 세대별 의상으로 변형(#29 참고). ⚠️ 의상 컨셉은 1990s/2000s/2010s/2020s 4종이 있지만 현재 확정된 세대 범위는 2000s/2010s/2020s 3종 — 범위 확장 여부는 별도 확인 필요.
